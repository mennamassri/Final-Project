      ...
      <div className="navbarBelt bg-dark d-none d-md-flex justify-content-between align-items-center ">
        <div className="leftNavbarBelt d-flex gap-2 justify-content-center align-items-center ">
          <div className="leftNavbarLogo  ">
            <a href="#">
              <img
                className="amazonLogoNavbar img-fluid "
                src={amazonLogo}
                alt="amazonLogo"
              />
            </a>
          ...
          <div className="location  ">
            <span id="deliver" className="m-3"> Deliver to </span>
            <div className="d-flex flex-row">
              <LocationOnIcon /> <p className="blod m-0 p-0">Palestinian Terri... </p>
            </div>
          </div>
        </div>
...
<div className="returnsOrders">
      ...
      <span className="font-wight-blod ">& Orders</span></a>
      </div>
     
          <div className="ShoppingCart">
            <span id="cartItems">0</span>
            <ShoppingCartOutlinedIcon style={{ color: "white", fontSize: "2rem" }} />
      ...
      <Navbar expand="lg" className="bg-dark  d-md-none p-0 " variant="dark" >
        <Container className="d-flex p-0 m-0">
           ...
           <Offcanvastool/>
            <Navbar.Brand href="#home" className="ms-2">
              ...
              <div className="leftNavbarLogo">
                <a href="#">
                  <img
                    className="amazonLogoNavbarMoblie img-fluid "
                    src={amazonLogo}
                    alt="amazonLogo"
                  />
                </a>
          ...
          <span className="p-3" style={{color:"white"}}>Sign in <PersonOutlineIcon style={{fontSize:"2rem"}}/> </span>
          <div className="ShoppingCart">
            <span id="cartItems">0</span>
            <ShoppingCartOutlinedIcon style={{ color: "white", fontSize: "2rem" }} />
            <span id="cart">Cart</span>
          ...
          <form className="d-flex" role="search">
            ...
            <input
              className="form-controlMobile me-2"
              type="search"
              placeholder="Search Amazon"
              aria-label="Search"
            />
